document.addEventListener("DOMContentLoaded", function() {
    ...
    if (mapElement) {
        ...
        const siteData = {
            "andaman_and_nicobar_1_": { title: "Heritage of Andaman & Nicobar", story: "Explore the colonial history of the Cellular Jail and the rich tribal heritage of these pristine islands.", model: null },
            "andhra_pradesh_1_": { title: "Heritage of Andhra Pradesh", story: "Home to sites like the Tirupati Temple and ancient Buddhist remains at Amaravati.", model: null },
            "arunachal_pradesh_1_": { title: "Heritage of Arunachal Pradesh", story: "Discover the 'Land of the Dawn-lit Mountains', with its diverse tribal cultures and the historic Tawang Monastery.", model: null },
            "assam_1_": { title: "Heritage of Assam", story: "Known for its lush tea gardens, the mighty Brahmaputra river, and the spiritual significance of the Kamakhya Temple.", model: null },
            "bihar_1_": { title: "Heritage of Bihar", story: "Discover the historic lands of Bihar, home to the ancient Nalanda University and the spiritual heartland of Buddhism.", model: null },
            "chandigarh_1_": { title: "Heritage of Chandigarh", story: "Explore the modernist architecture of Le Corbusier in India's first planned city.", model: null },
            "chhattisgarh_1_": { title: "Heritage of Chhattisgarh", story: "Known for its ancient caves, majestic waterfalls, and the rich traditions of its many indigenous communities.", model: null },
            "dadra_and_nagar_haveli_1_": { title: "Heritage of Dadra & Nagar Haveli and Daman & Diu", story: "A blend of Portuguese colonial charm and tribal culture, featuring historic forts and serene beaches.", model: null },
            "delhi_ncr_1_": { title: "Heritage of Delhi", story: "A city of cities, Delhi's heritage includes Mughal masterpieces like the Red Fort and Humayun's Tomb.", model: null },
            "Goa_1_": { title: "Heritage of Goa", story: "Explore the historic churches and convents of Goa, a UNESCO World Heritage site.", model: null },
            "gujarat_1_": { title: "Heritage of Gujarat", story: "Discover the architectural wonders of the Rani ki vav stepwell and the ancient Harappan city of Lothal.", model: null },
            "haryana_1_": { title: "Heritage of Haryana", story: "The historic land of the Mahabharata, Haryana holds ancient archaeological sites like Rakhigarhi.", model: null },
            "himachal_pradesh_1_": { title: "Heritage of Himachal Pradesh", story: "Nestled in the Himalayas, its heritage is rich with colonial architecture in Shimla and ancient Tibetan monasteries.", model: null },
            "jammu_and_kashmir_1_": { title: "Heritage of Jammu & Kashmir", story: "Often called 'Paradise on Earth', its heritage shines through its Mughal gardens and houseboats on Dal Lake.", model: null },
            "jharkhand_1_": { title: "Heritage of Jharkhand", story: "Explore the rich tribal culture, ancient temples, and the natural beauty of the 'Land of Forests'.", model: null },
            "Karnataka_1_": { title: "Heritage of Karnataka", story: "From the grand ruins of Hampi to the majestic palaces of Mysuru, Karnataka is a treasure trove of ancient empires.", model: null },
            "Kerala_1_": { title: "Heritage of Kerala", story: "Known as 'God's Own Country', Kerala's heritage is rich with serene backwaters and vibrant Kathakali dance forms.", model: null },
            "ladakh_1_": { title: "Heritage of Ladakh", story: "The 'Land of High Passes' is famed for its breathtaking landscapes and ancient Buddhist monasteries (gompas).", model: null },
            "lakshadweep_1_": { title: "Heritage of Lakshadweep", story: "A tropical archipelago with a unique heritage tied to the sea, featuring pristine coral reefs.", model: null },
            "madhya_pradesh_1_": { title: "Heritage of Madhya Pradesh", story: "The 'Heart of India', home to the Khajuraho temples and the Buddhist stupas of Sanchi.", model: null },
            "maharashtra_1_": { title: "Heritage of Maharashtra", story: "From the rock-cut Ajanta and Ellora Caves to the formidable sea forts of the Maratha Empire.", model: null },
            "manipur_1_": { title: "Heritage of Manipur", story: "The 'Jewel of India', known for its classical Manipuri dance and the unique floating islands of Loktak Lake.", model: null },
            "meghalaya_1_": { title: "Heritage of Meghalaya", story: "The 'Abode of Clouds', famed for its living root bridges and matrilineal societies.", model: null },
            "mizoram_1_": { title: "Heritage of Mizoram", story: "Experience the vibrant culture of the Mizo people through their traditional bamboo dance (Cheraw).", model: null },
            "nagaland_1_": { title: "Heritage of Nagaland", story: "A land of vibrant festivals and diverse warrior tribes, celebrated at the annual Hornbill Festival.", model: null },
            "odisha_1_": { title: "Heritage of Odisha", story: "Discover the architectural brilliance of the Konark Sun Temple and the spiritual aura of the Jagannath Temple in Puri.", model: null },
            "puducherry_1_": { title: "Heritage of Puducherry", story: "Discover the unique Franco-Tamil culture of Puducherry, its serene ashrams, and charming colonial architecture.", model: null },
            "punjab_1_": { title: "Heritage of Punjab", story: "The land of five rivers, its heritage is defined by the spiritual sanctity of the Golden Temple.", model: null },
            "rajasthan_1_": { title: "Heritage of Rajasthan", story: "Explore the majestic forts, opulent palaces, and vibrant culture of Rajasthan, the land of kings.", model: null },
            "sikkim_1_": { title: "Heritage of Sikkim", story: "A Himalayan wonderland with stunning views of Kangchenjunga and serene Buddhist monasteries.", model: null },
            "Tamil_Nadu_1_": { title: "Heritage of Tamil Nadu", story: "Home to ancient Dravidian civilization, boasting towering temple gopurams and the classical dance of Bharatanatyam.", model: null },
            "telangana_1_": { title: "Heritage of Telangana", story: "Discover Telangana's history through the Kakatiya dynasty's Thousand Pillar Temple and the iconic Charminar.", model: null },
            "tripura_1_": { title: "Heritage of Tripura", story: "A land of royal palaces like Ujjayanta Palace, ancient rock carvings, and rich bamboo craftsmanship.", model: null },
            "uttar_pradesh_1_": { title: "Heritage of Uttar Pradesh", story: "The heartland of India, home to the iconic Taj Mahal and the ancient city of Varanasi.", model: "assets/models/taj_mahal.glb" },
            "uttaranchal_1_": { title: "Heritage of Uttarakhand", story: "Known as 'Devbhumi' or the 'Land of the Gods', with pilgrimage sites like Haridwar and Rishikesh.", model: null },
            "west_bengal_1_": { title: "Heritage of West Bengal", story: "A land of poets and artists, its heritage spans from the colonial grandeur of Kolkata to the terracotta temples of Bishnupur.", model: null }
        };
    ...
    if (gamificationPage) {
        ...
        const renderPuzzles = () => {
            ...
            if (!container) return;
            container.innerHTML = `<div class="puzzle-image-wrapper" id="puzzle-image-wrapper"><img src="${puzzleData.image}" alt="${puzzleData.title}"></div><div class="clue-box" id="clue-box"><h5>${puzzleData.title}</h5><p>${puzzleData.intro}</p><hr><div id="clues-list"></div></div>`;
            currentClueIndex = 0;
